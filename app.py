...
# === FOOTER ===
st.markdown("""<hr><div style='text-align:center; font-size: 18px; color: #36030a;'>Made with ❤️ by Abhishek Singh | Powered by TensorFlow & Streamlit</div>""", unsafe_allow_html=True)
